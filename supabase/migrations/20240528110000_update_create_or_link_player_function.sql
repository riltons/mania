-- Atualização da função para criar ou vincular um jogador em uma transação
-- Corrigindo a lógica de verificação de jogadores existentes
...
BEGIN
  ...
  BEGIN
    ...
    -- Alterando a lógica para buscar apenas por telefone, que deve ser único
