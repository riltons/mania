-- Corrigir a função create_or_link_player para resolver o erro de ambiguidade de coluna
...
BEGIN
  ...
  BEGIN
    ...
    SELECT p.id, p.created_by != p_user_id INTO v_player_id, v_created_by_other_user
    FROM players p
