...
import { supabase, checkSupabaseConnectivity, supabaseUrl } from '../lib/supabase';
    ...
    const value = {
        ...
        signUp: async (email: string, password: string, name?: string) => {
            try {
                ...
                console.log('Verificando conectividade com o Supabase antes do registro...');
                const connectivityCheck = await checkSupabaseConnectivity();
                if (!connectivityCheck.success) {
                    console.error('Falha na verificação de conectividade com o Supabase:', connectivityCheck.error);
                    throw new Error('Não foi possível conectar ao servidor. Por favor, verifique sua conexão com a internet e tente novamente.');
                }
                
                console.log('Conectividade com o Supabase verificada, prosseguindo com o registro...');
                console.log('Tentando registrar com URL:', supabaseUrl);
