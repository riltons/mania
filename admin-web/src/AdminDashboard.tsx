...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ session }) => {
  ...
  async function fetchStats() {
    console.log('[AdminDashboard] fetchStats iniciada - session:', session);
    setLoading(true);
    setError(null);
    const adminClient = getAdminClient();
    console.log('[AdminDashboard] fetchStats - adminClient obtido');
    try {
  ...
  return (
    <div className="main-content">
      <div className="page-header">
        ...
        <div style={{display: 'flex', gap: '1rem', alignItems: 'center'}}>
          ...
          <div className="user-profile">
            <img src="data:image/svg+xml;base64," alt="Usuário" />
            <span>Admin</span>
          </div>
        </div>
      </div>
      ...
      {/* Resto do conteúdo do dashboard administrativo */}
